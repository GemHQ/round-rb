...
describe Round::Account do
  ...
  let(:account) { Round::Account.new(resource: account_resource, wallet: locked_wallet) }
  ...
  describe '#pay' do
    ...
    context 'when a transaction is attempted with an unlocked wallet' do
      ...
      let(:account) { Round::Account.new(resource: account_resource, wallet: unlocked_wallet) }
      before(:each) { 
  ...
  describe '#addresses' do
    ...
    it 'returns an AddressCollection' do
      expect(account.addresses).to be_a_kind_of(Round::AddressCollection)
    end
  ...
  describe '#transactions' do
    ...
    it 'returns a TransactionCollection' do
      expect(account.transactions).to be_a_kind_of(Round::TransactionCollection)
    end
  end

  describe '#payments' do
    it 'returns a PaymentGenerator' do
      expect(account.payments).to be_a_kind_of(Round::PaymentGenerator)
    end
  end
